...
| Gerenciamento Acadêmico | Funções relacionadas ao administrador | FGM32 |               O administrador deve ser capaz de cadastrar curso.       | *Somente o administrador pode cadastrar um curso |     Alta    |
