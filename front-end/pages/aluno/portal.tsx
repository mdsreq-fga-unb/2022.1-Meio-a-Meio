      ...
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          <h1 className={styles.title}>
            Bem vindo(a) ao Portal do Aluno
          </h1>
  
          <p className={styles.description}>
            Verifique aqui todo tipo de informação sobre os alunos do Galdi
          ...
          <Link href="/aluno/cadastro">
            ...
            >
              <h2>Listar &rarr;</h2>
              <p>
                Verifique aqui todos os alunos já cadastrados
              </p>
            </a>
            </Link>
          </div>
