...
export default function CadastroAluno() {
  ...
  const handleCheckData = () => {
    ...
    if(!endereco || endereco.length === 0) {
      emptyFields.endereco = "O campo de endereço não pode ser vazio"
    }
    if(!cep || cep.length === 0) {
      emptyFields.cep = "Preencha o CEP"
    }
    // if(cep.length < 11) {
    //   emptyFields.cep = "CEP inválido"
    // }
    ...
    if(!inadimplencia || inadimplencia.length === 0) {
      emptyFields.inadimplencia = "Preencha inadimplencia"
    }
        ...
        >
          ...
          <Grid item xs={4}>
              ...
              <Grid item xs={3}>
                ...
                <FormHelperText error>{errors.data_de_nascimento}</FormHelperText>
              </Grid>
              <Grid item xs={2}>
                <TextField
                  required
              ...
              <Grid item xs={2}> 
                <FormControl fullWidth>
                <FormLabel id="inadimplencia" required>Inadimplência?</FormLabel>
                <RadioGroup
                  row
                  aria-labelledby="demo-row-radio-buttons-group-label"
                  name="row-radio-buttons-group"
                  onChange={(e) => setData({...data, inadimplencia:e.target.value === 'sim'||false})}
                  value={data?data.inadimplencia:null}
                >
                <FormControlLabel value="sim" control={<Radio />} label="Sim" />
                <FormControlLabel value="nao" control={<Radio />} label="Não" />
                </RadioGroup>
                <FormHelperText error>{errors.inadimplencia}</FormHelperText>
                </FormControl>
              </Grid>
              <Grid item xs={3}>
                <TextField
              ...
              <Grid item xs={4.5}>
                <TextField
                  ...
                  helperText={errors.endereco||null}
                  fullWidth
                  name="endereco"
                  label="Endereço"
                  type="endereco"
            ...
            <Button
              ...
              sx={{ mt: 3, mb: 2 }}
            >
              Insira os dados cadastrais do aluno
            </Button>
