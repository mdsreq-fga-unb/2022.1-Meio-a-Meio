...
export default function Cadastro() {
  ...
  const handleOnlyNumber = (e: ChangeEvent<HTMLInputElement>) => {
    const clearNumber = e.target.value.replace(/\D/, "");
  ...
  const handleCheckData = () => {
    ...
    if (!especialista || especialista.length === 0) {
      emptyFields.especialista = "Preencha especialista";
    }
        ...
        >
          ...
          >
            <Grid container spacing={2}>
              ...
              <Grid item xs={1.8}>
                <FormControl fullWidth>
                  <FormLabel id="especialista" required>
                    Especialista?
                  </FormLabel>
                  <RadioGroup
                    row
                  ...
                  <FormHelperText error>{errors.especialista}</FormHelperText>
                </FormControl>
              </Grid>
              <Grid item xs={4}>
                <TextField
